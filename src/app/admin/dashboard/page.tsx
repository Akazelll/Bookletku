...
export default async function DashboardPage() {
  // Ambil data menu dan statistik secara paralel
        ...
        <div className='bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm h-fit'>
          <div className='p-6 border-b border-zinc-100 dark:border-zinc-800'>
            ...
            <p className='text-xs text-zinc-500 mt-1'>
              Menu dengan interaksi terbanyak
            </p>
          </div>
          <div className='p-2'>
            {stats.popularItems.length === 0 ? (
              ...
              <ul className='divide-y divide-zinc-100 dark:divide-zinc-800'>
                {stats.popularItems.map((item, index) => (
                  <li
                    key={index}
                    className='flex justify-between items-center p-4 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 rounded-lg transition-colors'
                  >
