...
const menuItems = [
  ...
  {
    title: "Daftar Menu",
    href: "/admin/menu/list", // Nanti kita buat page ini
    icon: UtensilsCrossed,
  },
  {
    title: "QR Code",
    href: "/admin/qr", // Opsional
    icon: QrCode,
  },
  {
    title: "Pengaturan",
...
export default function AdminSidebar() {
  ...
  return (
    <aside className='flex flex-col h-full w-64 bg-white dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-800'>
      {/* Logo Area */}
